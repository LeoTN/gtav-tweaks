...
reloadScriptPrompt()
{
    ...
    reloadScriptGUI := Gui(, "Tweaks - Reloading Script")
...
terminateScriptPrompt()
{
    ...
    terminateScriptGUI := Gui(, "Tweaks - Terminating Script")
...
displayErrorMessage(pErrorObject := unset, pAdditionalErrorMessage := unset, pBooleanTerminatingError := false, pMessageTimeout := unset)
{
    ...
    If (IsSet(pMessageTimeout))
    {
        ...
        {
            result := MsgBox(errorMessageBlock . "`n`nPress [Yes] to copy error to clipboard.", "Tweaks - Error Details", "YN IconX T" . pMessageTimeout)
        }
        Else
        {
            result := MsgBox(errorMessageBlock . "`n`nPress [Yes] to copy error to clipboard.", "Tweaks - Error Details", "YN IconX")
        }
    }
    Else
    {
